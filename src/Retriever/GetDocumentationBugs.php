...
final class GetDocumentationBugs implements Retriever
{
    ...
    public function retrieve(): Promise
    {
        return call(function () {
            ...
            $dom = yield $this->httpClient->requestHtml(
                'https://bugs.php.net/search.php?limit=30&order_by=id&direction=DESC&cmd=display&status=Open&bug_type=Documentation+Problem',
            );
