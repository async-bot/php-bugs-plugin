...
use AsyncBot\Plugin\PhpBugs\Retriever\GetDocumentationBugs;
use AsyncBot\Plugin\PhpBugsTest\Fakes\HttpClient\MockResponseInterceptor;
use PHPUnit\Framework\TestCase;
use function Amp\Promise\wait;

final class GetDocumentationBugsTest extends TestCase
{
    public function testRetrieveReturnsBugs(): void
    {
        ...
        $status = wait((new GetDocumentationBugs($httpClient, new Parser()))->retrieve());
